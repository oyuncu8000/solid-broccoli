...
<body>
    ...
    <div class="menu-container">
        ...
        <div id="myDropdown" class="dropdown-content">
            <a href="javascript:void(0)" onclick="siteDegistir('https://cloudpro01.player4me.xyz/#vtav6', 'Bölüm 1')">Bölüm 1</a>
        </div>
    </div>

    <iframe id="content-frame" src="https://cloudpro01.player4me.xyz/#vtav6" allowfullscreen></iframe>
